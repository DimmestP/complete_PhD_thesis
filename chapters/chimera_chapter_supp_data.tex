...
\begin{table}[h!]\centering \begingroup\setlength{\tabcolsep}{5pt}\fontsize{6}{6}\selectfont{\begin{tabular}{ c c }\textbf{mCherry} & \textbf{mTurq} \\ pRPS3 &  \\
...
\begin{table}\centering \begingroup\setlength{\tabcolsep}{5pt}\fontsize{6}{6}\selectfont{\renewcommand{\arraystretch}{1}\begin{tabular}{ c c }\textbf{mod\_NAA} & \textbf{mod\_NTN} \\
\begin{tabularx}{0.45\textwidth} { 
  | >{\centering\arraybackslash}X 
  | >{\centering\arraybackslash}X  
  | >{\centering\arraybackslash}X
...
\begin{table}\centering \begingroup\setlength{\tabcolsep}{5pt}\fontsize{6}{6}\selectfont{\renewcommand{\arraystretch}{1}\begin{tabular}{ c c }\textbf{mod\_NTHHH} & \textbf{mod\_ANHHH} \\
\begin{tabularx}{0.45\textwidth} { 
  | >{\centering\arraybackslash}X 
  | >{\centering\arraybackslash}X  
  | >{\centering\arraybackslash}X
...
\hline
\end{tabularx}
\\\textbf{mod\_ATNHH} & \textbf{mod\_ATHNH} \\
\begin{tabularx}{0.45\textwidth} { 
  | >{\centering\arraybackslash}X 
  | >{\centering\arraybackslash}X  
  | >{\centering\arraybackslash}X
...
\begin{table}\centering \begingroup\setlength{\tabcolsep}{5pt}\fontsize{6}{6}\selectfont{\renewcommand{\arraystretch}{1}\begin{tabular}{ c c }\textbf{ATATTC} & \textbf{TGTAHMNTA and HWNCATTWY} \\
\begin{tabularx}{0.45\textwidth} { 
  | >{\centering\arraybackslash}X 
  | >{\centering\arraybackslash}X  
  | >{\centering\arraybackslash}X
